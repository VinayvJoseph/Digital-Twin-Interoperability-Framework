# client - persistent registration removed
...
CLIENT_ID_LOCAL = 'DTSRS' # Synonymous with K.G
CLIENT_ID = ''
...
ip_broker = 'kafka' # ip address of your kafka broker
port_broker = '29093'
ip_neo4j = '131.155.223.45' # ip address of youe neo4j server
port_neo4j = '7687'
...
# Redis Configuration
redis_host = 'redis' # When client runs in docker, mention container name 'redis' and not 'localhost'
redis_port = 6379
